...
const Services = () => {
  // Calculate the new card width (327.5px * 1.1 = 360.25px)
  const cardWidth = 360.25;
  // Calculate total width for 3 cards plus 2 gaps (1.5rem = 24px)
  const totalWidth = (cardWidth * 3) + (24 * 2); // 1128.75px
  ...
  return (
    <section className="section-container" id="services">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-[1128.75px] mx-auto mt-12">
        {services.map((service) => (
          <Card 
            key={service.title}
            className="group relative overflow-hidden border-white/10 hover:border-[#f15a2b] bg-black/50 hover:bg-white transition-all duration-300 rounded-none aspect-[3/4] w-[360.25px]"
          >
