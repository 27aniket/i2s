    ...
    <section className="section-container" id="services">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        {services.map((service) => (
          <Card 
            key={service.title}
            className="group relative overflow-hidden border-white/10 bg-black/50 hover:bg-white transition-all duration-300 rounded-none aspect-[3/4] w-[300px] mx-auto"
          >
